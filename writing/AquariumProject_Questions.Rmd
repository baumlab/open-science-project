...
* random slope for country, random intercept for year  
...
glmer(volume ~ range size + CITES + gov.indicator + (1 + range size | year / country), data=trade, family = Gamma(link=log))  
