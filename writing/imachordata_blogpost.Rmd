...
In light of [recent political moves towards greater oil extraction in N America] (news article), we decided to examine oil spill impacts across the west coast of North America. We focused on shellfish fisheres, reasoning that [sessile organisms would experience high mortality soon after an oil spill] (REF), and that [subsequent fisheries closures] (example of fisheries closures) would instantly impact catch. Oil
