...
Jillian Dunic: PhD student at Simon Fraser University, studying the effect of multiple stressors on tipping points in eelgrass. 
...
As mentioned earlier, we used Rmarkdown and Github to manage our workflow. We met once every one or two weeks on Skype to discuss project goals and delegated tasks, taking notes on Skype calls in a publicly accessible [etherpad](https://public.etherpad-mozilla.org/). These meetings, combined with Github, allowed us to divide and conquer without duplicating each other's work. The goal was to have everyone only spend 1-3 hours on the project per week (after all, we each have dissertations to write). Everyone contributed to coding in R---whether it was data cleaning, analysis, or visualizations---and writing the intial manuscript. We also used [Slack](https://slack.com/) to regularly chat about the project in between Skype meetings. Slack eliminates the need for endless email chains and slack can also integrate Github, allowing particpants to be notified when a change on Github has occurred. In the future, we might take notes on a markdown file that can be easily version controlled, and may make use of Github's wiki and project planning features.
...
But, we are now brainstorming conservation questions for our next attempt. Ecologists, please, send us your unanswered conservation problems, unanalyzed datasets, and suggestions for advancing open ecology! This time we are taking the approach of bringing datasets and questions to the brainstorming session. We will let you know how this progresses!

James Robinson, Danielle Claar, Jillian Dunic, Jamie McDevitt-Irwin, Geoffrey Osgood, Easton White
